...
## Customized by Cloudkernel Technologies(Shenzhen) Co.,Ltd for users in Mainland China
## http://cloudkernel-tech.github.io
...
echo "we have to run ubuntu_sim_common_deps first, use downloaded script here!"
. ubuntu_sim_common_deps.sh

# change pip install source 
echo "change pip install source to tsinghua mirror"
